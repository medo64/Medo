...
namespace Tests.Medo.Configuration {
    public class IniFileTests {
        ...
        private static Stream GetResourceStream(string resourceName) {
            var resAssembly = typeof(IniFileTests).GetTypeInfo().Assembly;
            return resAssembly.GetManifestResourceStream("Tests.Medo._Resources.Configuration.IniFile." + resourceName);
        }
