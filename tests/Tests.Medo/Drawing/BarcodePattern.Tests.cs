...
namespace Tests.Medo.Drawing {
    public class BarcodePatternTests {
        ...
        public void CodabarWritePng() {
            ...
            bp.WritePngImageToStream(memStream);
            //File.WriteAllBytes(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "codabar-24.png"), memStream.ToArray());
        ...
        public void CodabarWriteTransparentPng() {
            var bp = BarcodePattern.GetNewCodabar("1234");
            var memStream = new MemoryStream();
            bp.WritePngImageToStream(memStream, Color.Blue, Color.Transparent);
            //File.WriteAllBytes(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "codabar-32.png"), memStream.ToArray());
        ...
        public void Code128WritePng() {
            ...
            var memStream = new MemoryStream();
            bp.WritePngImageToStream(memStream);
            //File.WriteAllBytes(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "code128-24.png"), memStream.ToArray());
        ...
        public void Code128WriteTransparentPng() {
            ...
            var memStream = new MemoryStream();
            bp.WritePngImageToStream(memStream, Color.Blue, Color.Transparent);
            //File.WriteAllBytes(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "code128-32.png"), memStream.ToArray());
