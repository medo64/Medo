...
public class BarcodePattern_Tests {
    ...
    public void BarcodePattern_CodabarWritePng() {
        ...
        Assert.AreEqual(146, memStream.Length);
        Assert.AreEqual("",
...
#if NET10_0_OR_GREATER
        Assert.AreEqual(157, memStream.Length);
        Assert.AreEqual("",
                        BitConverter.ToString(memStream.ToArray()).Replace("-", ""));
#elif NET7_0_OR_GREATER
...
#if NET10_0_OR_GREATER
        Assert.AreEqual(138, memStream.Length);
        Assert.AreEqual("",
                        BitConverter.ToString(memStream.ToArray()).Replace("-", ""));
#elif NET7_0_OR_GREATER
...
#if NET10_0_OR_GREATER
        Assert.AreEqual(146, memStream.Length);
        Assert.AreEqual("",
                        BitConverter.ToString(memStream.ToArray()).Replace("-", ""));
#elif NET7_0_OR_GREATER
