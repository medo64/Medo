...
public class Crc32_Tests {
    ...
    public void Crc32_Aixm_2() {
        ...
        Assert.AreEqual((uint)0x3010BF7F, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_Autosar_2() {
        var crc = Crc32.GetAutosar();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x1697D06A, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_Base91D_2() {
        var crc = Crc32.GetBase91D();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x87315576, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_BZip2_2() {
        var crc = Crc32.GetBZip2();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0xFC891918, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_CdromEdc_2() {
        var crc = Crc32.GetCdromEdc();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x6EC2EDC4, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_Cksum_2() {
        var crc = Crc32.GetCksum();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x765E7680, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_IScsi_2() {
        var crc = Crc32.GetIScsi();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0xE3069283, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_IsoHdlc_2() {
        var crc = Crc32.GetIsoHdlc();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0xCBF43926, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_JamCrc_2() {
        var crc = Crc32.GetJamCrc();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x340BC6D9, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_Mpeg2_2() {
        var crc = Crc32.GetMpeg2();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0x0376E6E7, (uint)crc.HashAsUInt32);
    }
    ...
    public void Crc32_Xfef_2() {
        var crc = Crc32.GetXfer();
        crc.Append(Encoding.ASCII.GetBytes("123456789"));
        Assert.AreEqual((uint)0xBD0BE338, (uint)crc.HashAsUInt32);
    }
